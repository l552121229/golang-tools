...
const (
	// ApplicationBase 环境变量中，设置程序运行所需要文件的基准路径，
	// 如果环境变量中，WI_HOME变量值为空，
	// 则ApplicationBase值为当前程序运行目录。
	ApplicationBase = "WI_HOME"
	// DefaultConfigFile 配置文件相对于环境变量WI_HOME的相对路径
...
// SetLogOutputDir 设置日志文件输出目录，当目录为空时，则指向当前运行程序所在的目录
